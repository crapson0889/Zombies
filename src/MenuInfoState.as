package  
{
	...
	public class MenuInfoState extends FlxState
	{
		...
		override public function create():void 
		{
			...
			"This game was created for a class project for CECS 550 for the University of Louisville Speed School of Engineering.\n\n" + 
			"Credits: \nChristopher Rapson\nPhillip Rose\nSteven Harris\nMike Zanchi\nJesse Garrett");
			instructions.shadow = 0xff333333;
			add(instructions);
			
			var version:FlxText = new FlxText(50, FlxG.height - 30, 300, "Ver 0.22 b");
